...
namespace TestImages
{
	...
	public static class MemoryManagement
	{
		...
		public static bool CheckMemory(string eventDescription, bool okToBotherUser, bool forceFullCollection = true)
		{
			...
			{
				s_warningShown = true;
				Console.WriteLine("Unfortunately, the program is starting to get short of memory.");
			}
			return danger;
		}
